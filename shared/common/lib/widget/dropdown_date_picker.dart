...
class DropdownDatePicker extends StatefulWidget {
  ...
  ValueChanged<int?>? onChangedDay;

  ///Return selected month
  ValueChanged<int?>? onChangedMonth;

  ///Return selected year
  ValueChanged<int?>? onChangedYear;
...
class _DropdownDatePickerState extends State<DropdownDatePicker> {
  ...
  monthSelected(value) {
    print("object $value");
    widget.onChangedMonth?.call(int.tryParse(value));
    monthselVal = value;
  ...
  daysSelected(value) {
    widget.onChangedDay?.call(int.tryParse(value));
    dayselVal = value;
    update();
  }
  ...
  yearsSelected(value) {
    widget.onChangedYear?.call(int.tryParse(value));
    yearselVal = value;
    if (monthselVal != '') {
      int days = daysInMonth(
          yearselVal == '' ? DateTime.now().year : int.parse(yearselVal),
